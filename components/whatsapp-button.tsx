...
export function WhatsAppButton() {
  const phoneNumber = "+64273498859"
  const message = encodeURIComponent("Hello Madras Kitchen, I would like to know more about your menu and services.")
  ...
  return (
    ...
    >
      ...
      <span className="absolute w-full h-full rounded-full bg-[#25D366] animate-pulse opacity-20" />
