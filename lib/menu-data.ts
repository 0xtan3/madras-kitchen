...
export const vegSections: MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Dahi Vada (2 Nos)', description: 'Soft lentil dumplings topped with chilled creamy curd and spices.', price: '$11.99', imageQuery: 'dahi vada curd indian', localFallback: M.vRasamVada },
...
export const nonVegSections: MenuSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Parotta with Chicken 65', description: 'Parotta served with chicken 65.', price: '$25.99', imageQuery: 'parotta chicken 65 south indian', localFallback: M.parottaChicken65 },
      { name: 'Parotta with Goat 65', description: 'Parotta served with goat 65.', price: '$27.99', imageQuery: 'parotta goat 65 south indian', localFallback: M.parottaChicken65 },
